#PastDeux (Collaborative Project)
...
-> Managed parsing and clean formatting of JSON API responses for email output.
-> Worked with teammates to link AI-generated email text to the app’s existing task database and user account system.
-> Debugged backend workflow issues and ensured seamless connection between the AI system and user interface.
